...
List<GetChatsModel> getChatsModelFromJson(String str) => List<GetChatsModel>.from(json.decode(str).map((x) => GetChatsModel.fromJson(x)));

String getChatsModelToJson(List<GetChatsModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
