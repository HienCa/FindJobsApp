...
class _ProfileUpdatePageState extends State<ProfileUpdatePage> {
  ...
  @override
  void initState() {
    locationTextEditingController.text = widget.profile.location;
    phoneTextEditingController.text = widget.profile.phone;
    profileTextEditingController.text = widget.profile.profile;
    skill1TextEditingController.text = widget.profile.skills[0];
    skill2TextEditingController.text = widget.profile.skills[1];
    skill3TextEditingController.text = widget.profile.skills[2];
    skill4TextEditingController.text = widget.profile.skills[3];
    skill5TextEditingController.text = widget.profile.skills[4];
    super.initState();
  }
                ...
                Row(
                  ...
                  children: [
                    MyText(
                        ...
                        style:
                            appstyle(24, Color(kDark.value), FontWeight.bold)),
                      ...
                      builder: (context, imageNotifier, child) {
                        return MyButton(
                          ...
                          onTap: () {
                            ...
                            //       "Please Please upload an image to procced!",
